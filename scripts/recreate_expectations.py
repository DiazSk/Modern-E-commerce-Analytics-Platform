...
def main():
    ...
    try:
        ...
        batch_request = RuntimeBatchRequest(
            ...
            batch_identifiers={"default_identifier_name": "fact_orders_sample"},
        )
        ...
        validator.expect_column_values_to_be_between(
            column="unit_price", min_value=0.01, max_value=10000.00
        )
        print("✓ 9/15: unit_price range")

        validator.expect_column_values_to_be_between(
            column="line_total", min_value=0, max_value=None
        )
        print("✓ 10/15: line_total range")

        validator.expect_column_values_to_be_between(
            column="discount_amount", min_value=0, max_value=None
        )
